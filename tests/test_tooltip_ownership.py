...
class TooltipOwnershipTest(unittest.TestCase):
    ...
    def test_attendance_spec_icon_hover_uses_shared_tooltip_owner(self):
        ...
        self.assertIn("local BindTooltipModel = assert(Tooltips.BindModel", attendance)
        self.assertIn('"Attendance tooltip model binder is not initialized"', attendance)
        self.assertIn("BindTooltipModel(icon, function(self)", bind_spec_icon_tooltip)
        self.assertIn("return nil", bind_spec_icon_tooltip)
        self.assertIn("return {", bind_spec_icon_tooltip)
        self.assertIn("title = specName", bind_spec_icon_tooltip)
        self.assertIn("lines = {}", bind_spec_icon_tooltip)
        self.assertIn('anchor = "ANCHOR_RIGHT"', bind_spec_icon_tooltip)
        self.assertIn('end, "ANCHOR_RIGHT")', bind_spec_icon_tooltip)
        self.assertNotIn("BindTooltip(icon, function", bind_spec_icon_tooltip)
        self.assertNotIn("ShowTooltipLines", bind_spec_icon_tooltip)
