...
local GetItemStringFromLink = assert(Item.GetItemStringFromLink, "Loot reconcile item-key resolver is not initialized")
local NormalizeName = assert(Strings.NormalizeName, "Loot reconcile name normalizer is not initialized")
