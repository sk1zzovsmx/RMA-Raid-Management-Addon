...
L.StrConfigHelpCommandsBody = "/rma help [topic]: show command help in chat.\n\n"
	.. "/rma config [reset]; /rma ml; /rma counter; /rma history; /rma attendance; /rma warnings; /rma lfm [start|stop]; /rma reserves [import].\n\n"
	.. "/rma history req <raid> <player>; /rma history push <raid> <player>; /rma history sync.\n"
	...
	.. "/rma ach <achievement-id>; /rma specinspect [force]; /rma validate raids [verbose]; /rma minimap [show|hide|pos <0-360>]; /rma perf [on|off|threshold <ms>|report|audit|sync|items|reset]; /rma version [local]; /rma bug.\n\n"
