...
Diag.W.LogMLPendingAwardExecutionFailed = "[ML] Pending award execution cancelled item=%s player=%s reason=%s"
Diag.W.LogMLPendingAwardExecutionTimeout =
	"[ML] Pending award execution unconfirmed after %ds item=%s player=%s slot=%s"
