...
do
    ...
    local getFrame = makeModuleFrameGetter(module, "RMAReserveListFrame")
    ...
    local getImportFrame = makeModuleFrameGetter(Import, "RMAImportWindow")
    ...
    local function ensureWrongCSVPopup()
        ...
        if StaticPopupDialogs["RMA_WRONG_CSV_FOR_PLUS"] then
            return
        end

        StaticPopupDialogs["RMA_WRONG_CSV_FOR_PLUS"] = {
    ...
    importFromEditBox = function()
        ...
        if not parsed then
            if errCode == "CSV_WRONG_FOR_PLUS" then
                ...
                StaticPopup_Show("RMA_WRONG_CSV_FOR_PLUS", nil, nil, popupData)
